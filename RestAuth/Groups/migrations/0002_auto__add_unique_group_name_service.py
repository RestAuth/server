...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Group', fields ['name']
        db.create_index('Groups_group', ['name'])

        # Adding unique constraint on 'Group', fields ['name', 'service']
        db.create_unique('Groups_group', ['name', 'service_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Group', fields ['name', 'service']
        db.delete_unique('Groups_group', ['name', 'service_id'])

        # Removing index on 'Group', fields ['name']
        db.delete_index('Groups_group', ['name'])


    models = {
        'Groups.group': {
            'Meta': {'unique_together': "(('name', 'service'),)", 'object_name': 'Group'},
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 27, 18, 23, 13, 861897)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 27, 18, 23, 13, 861789)'}),
